<section>
    ...
    <form class="mt-6 space-y-6" method="post" action="{{ route('password.update') }}">
        ...
        <div>
            ...
            <input class="mt-1 block w-full rounded-lg" id="update_password_current_password" name="current_password"
        ...
        <div>
            ...
            <input class="mt-1 block w-full rounded-lg" id="update_password_password" name="password" type="password"
        ...
        <div>
            ...
            <input class="mt-1 block w-full rounded-lg" id="update_password_password_confirmation"
