    ...
    <div class="px-12">
        <section class="home" id="home">
            ...
            <div class="content">
                ...
                <a class="btnappointment" href="#"> Book An Appointment <span class="fas fa-chevron-right"></span></a>
            </div>
        </section>
        ...
        <section class="about" id="about">
            ...
            <div class="row">
                ...
                <div class="content">
                    ...
                    <p class="py-4 text-2xl">Random provides a place to compare wait times at clinics,hospitals in your area
                        and
                        then
                        get it right
                        form your phone-empowering you to find the right facility and skip the agony of waiting room.</p>
                </div>
            </div>
        </section>
        <section class="review" id="review">
            ...
            <div class="box-container px-32">
                <div class="box transition-transform ease-in-out hover:scale-105">
                    ...
                    <p class="py-4 text-xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse laboriosam
                        accusamus
                        aperiam
                        dolores soluta repellendus. Ipsa, atque ratione. Repellendus ipsa voluptas deserunt quod officiis
                        quas,
